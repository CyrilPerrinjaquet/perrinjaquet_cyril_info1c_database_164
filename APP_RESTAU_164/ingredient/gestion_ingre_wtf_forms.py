...
champ_ingre_regexp = "^([A-Z]|[a-zÀ-ÖØ-öø-ÿ])[A-Za-zÀ-ÖØ-öø-ÿ]*['\- ]?[A-Za-zÀ-ÖØ-öø-ÿ]+$"
class FormWTFAjouterIngredient(FlaskForm):
    """
        Dans le formulaire "ingre_ajouter_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """

    nom_ingre_wtf = StringField("Clavioter le nom de l'ingrédient ", validators=[Length(min=2, max=50, message="min 2 max 50"),
                                                                   Regexp(champ_ingre_regexp,
...
class FormWTFDeleteIngredient(FlaskForm):
    ...
    """
    nom_ingre_delete_wtf = StringField("Supprimer cet ingrédient")
    submit_btn_del = SubmitField("Supprimer ingrédient")
